...
do
	...
	do
		...
		python3 simulation/sim.py -workload "$trace" -load 1.2 -num_gpus 64 -num_apps 3000 -scheduling_policy MCS -output_file "$output_file" -MCS_config_file data/PCS_configs/PCS_config_"$trace"_"$var".pkl
		echo "PCS_$var" done
	done
